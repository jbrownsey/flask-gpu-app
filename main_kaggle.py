...
secret_value_0 = user_secrets.get_secret("airtable")
secret_value_1 = user_secrets.get_secret("ngrok")
secret_value_2 = user_secrets.get_secret("openai")

conf.get_default().auth_token = secret_value_1
api_key = secret_value_2
airtable_api_key = secret_value_0
